...
7. [x] **Clarify as Project** -- Inbox -> new project + first next action
8. [x] **Waiting For** -- Delegation tracking
9. [x] **Clarify as Waiting For** -- Inbox -> waiting for
10. [ ] **Someday/Maybe** -- Idea parking  <!-- NEXT -->
